  ...
  return (
    <div className="w-full h-[90px] bg-black shadow-lg fixed top-0 left-0 z-40 ">
      <div className="max-w-[1240px]  mx-auto px-4 flex justify-between items-center h-full md:flex-row ">
        ...
        <div
          className={` ${
            showNav ? "flex z-40 " : "hidden"
          } md:flex duration-300`}
        >
          <ul
            className={`flex text-white  md:justify-center  items-center md:flex  ${
              showNav
          ...
          >
            ...
            <button className="ml-4 cursor_pointer px-8 text-2xl mb-3  bg-gradient-to-r from-[var(--primary-purple)] to-[var(--primary-blue)] py-3  rounded-3xl ">
              Sign in
            </button>
          </ul>
        </div>
